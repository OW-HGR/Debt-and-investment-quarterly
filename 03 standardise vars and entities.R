...
write.csv(debt_and_investments, file = "Debt and investment outturn, 2008-09 to Q4 2019-20.csv", row.names = FALSE)
#write.csv(debt_and_investments_wide, file = "Debt and investment outturn, 2008-09 to Q4 2019-20 - wide format.csv", row.names = FALSE)
